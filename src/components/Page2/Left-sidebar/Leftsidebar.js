          ...
          <ul class="space-y-2">
            <li>
              ...
              >
                <svg
                  aria-hidden="true"
                  class="w-6 h-6 text-gray-500 transition duration-75 #e3f2f3:text-gray-400 group-hover:text-gray-900 #e3f2f3:group-hover:text-#e3f2f3"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                  xmlns="http://www.w3.org/2000/svg"
                >
            ...
            <li>
              ...
              >
                <svg
                  aria-hidden="true"
                  class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 #e3f2f3:text-gray-400 group-hover:text-gray-900 #e3f2f3:group-hover:text-#e3f2f3"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                  xmlns="http://www.w3.org/2000/svg"
                >
