  ...
  return (
    ...
    <div className=" h-10 bg-yellow-300">
      <div className="flex justify-center items-center">
        ...
        { fakeUser == "shafayat" && getOperation.length > 0 && getToggleVal === false &&  getOperation[0].Description}
        { fakeUser == "shafayat" && getOperation.length > 0 && getToggleVal === true &&   getOperation[1].Description }
        { fakeUser != "shafayat" && getOperation.length > 0 &&  getOperation[2].Description }

        </p>
        { fakeUser == "shafayat" && 

        <label className="relative inline-flex items-center cursor-pointer">
           <input type="checkbox" value="" className="sr-only peer" onChange={toggleOnchange}/>
